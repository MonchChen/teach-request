...
@Network(url = "http://192.168.1.101:8094/teach/api/register")
public class RegisterNetwork extends AppNetwork {

    private static final String TAG = "RegisterNetwork";

    public RegisterNetwork(ApiRequest.Builder builder) {
        super(builder);
    }
